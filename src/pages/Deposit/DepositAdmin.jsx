...
export default function DepositAdmin() {
  ...
  return (
    <div className='h-full'>
      ...
      <div className="flex bg-white dark:bg-dark-bg p-6 min-h-full">
          ...
          <table className='w-full text-sm text-left text-gray-500 dark:text-gray-400'>
            ...
            <tbody>
              {deposits.map((deposit, index) => (
                <tr className={`cursor-pointer ${index % 2 === 0 ? "bg-gray-50 dark:bg-dark-bg-700" : ""} hover:bg-gray-100 dark:hover:bg-dark-bg-600`} key={index}
