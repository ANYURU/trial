      ...
      <div className='h-full'>
        ...
        <div className="flex bg-white dark:bg-dark-bg-700 dark:text-secondary-text p-6 min-h-full">
            <div className='flex flex-grow flex-col min-h-full'>
              {pageNumber === 1 &&
                <ApplicationPg1 initialValues={initialValues} setInitialValues={setInitialValues} setPageNumber={setPageNumber} pageNumber={pageNumber}/>
              }
              {
                pageNumber === 2 
                &&    
                <ApplicationPg2 initialValues={initialValues} setInitialValues={setInitialValues} setPageNumber={setPageNumber} pageNumber={pageNumber} password={password} setPassword={setPassword}/>  
              }
              {
                pageNumber === 3 
                && 
                <ApplicationVerify values={initialValues} password={password} setPassword={setPassword} setInitialValues={setInitialValues}/>
              }
