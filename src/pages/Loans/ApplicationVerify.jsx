...
function ApplicationVerify() {
  return (
    <div className='flex flex-col justify-center items-center h-full'>
        ...
        <div className='w-56'>
            <input type="text" name="" id="" placeholder='Enter OTP' className='ring-1 ring-black rounded px-2 py-1 mt-2' />
        </div>
        <button className='w-56 bg-primary rounded-lg border-0 px-4 py-1 my-2 text-white'>Verify</button>
        <button className='w-56 outline outline-1 outline-gray-400 rounded-lg px-3 py-1 my-2 text-gray-400'>Resend OTP</button>
    </div>
  )
}
