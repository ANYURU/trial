    ...
    matches
        ?
          <div className="flex justify-between mb-5 gap-5 dark:text-white">
              <div className="bg-white w-3/12 flex flex-col shadow-md py-7 rounded-md justify-center items-center dark:bg-dark-bg-700">
        ...
        :
          <div className="flex flex-col gap-5 mb-5  dark:text-white">
            <div className="flex gap-5">
              <div className="bg-white dark:bg-dark-bg-700  w-6/12 flex flex-col shadow-sm py-7 rounded-md justify-center items-center">
                <h1 className="font-bold text-2xl">{deposits}</h1>
                <h1 className="font-semibold">Deposits</h1>
              </div>
              <div className="bg-white dark:bg-dark-bg-700 w-6/12 flex flex-col shadow-sm py-7 rounded-md justify-center items-center">
