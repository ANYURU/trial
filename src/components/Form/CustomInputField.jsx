export const InputField = ({ errors, defaultValue="", touched, reference, id, label, handleChange, handleBlur, ...props }) => (
    <div className='flex flex-col w-56'>
        ...
        <input type="text" className='ring-1 ring-black rounded px-2 py-1 dark:bg-dark-bg-600' onChange={handleChange(reference)} defaultValue={defaultValue} onBlur={handleBlur(reference)} {...props}/>
