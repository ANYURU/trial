                ...
                <div className={`flex justify-between p-1 py-2 border-b-[1px] items-center`}>
                    <div className='pl-2 justify-center items-center flex h-full gap-1'>
                        ...
                        onlineMembers.find(member => member === selectedMember.receiver_id) ? <span className="text-xs text-green-300"> online </span> : <span className="text-xs">
                            {
                                (selectedMember.receiver_id !== my_id && selectedMember?.last_seen)
                                ? 
                                `last seen ${getFormattedDate(new Date(selectedMember.last_seen))}`
                                :
                                ""
                            }   
                            {/* {console.log("receivers id", selectedMember.receiver_id)}
